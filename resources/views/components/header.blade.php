            ...
            <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between relative ">
                ...
                <div class="flex items-center gap-2 md:gap-4">
                    ...
                    <div class="hidden sm:flex items-center gap-3 px-2">
                        @guest
                            <a class="bg-primary text-white hover:bg-secondary text-sm font-bold px-5 py-2.5 rounded-lg hover:shadow-lg  transition-all" href="/login">Se connecter</a>
                        @endguest
                        @auth
                    ...
                    <div class="hidden absolute top-20 left-0 w-full bg-white dark:bg-charcoal border-b border-slate-200 dark:border-white/10 flex-col p-6 gap-6 lg:hidden shadow-xl" id="mobile-menu">
                        <nav class="flex flex-col gap-4">
                            ...
                            <a class="text-sm font-semibold hover:text-primary transition-colors" href="/search">Trouver un trajet</a>
                            <a class="text-sm font-semibold hover:text-primary transition-colors" href="/marche">Comment ça marche</a>
                        ...
                        <div class="flex flex-col gap-3">
                            @guest
                                <a class="w-full text-center py-4 font-bold bg-primary text-white hover:bg-secondary rounded-xl" href="/login">Se connecter</a>
                            @endguest
                        </div>
                    </div>
                </div>
