<section class="py-12 sm:py-24 bg-white dark:bg-background-dark">
                <div class="max-w-7xl mx-auto px-4 sm:px-6">
                    <div class="text-center mb-10 sm:mb-16">
                        <h2 class="text-2xl sm:text-3xl md:text-4xl font-extrabold text-deep-blue dark:text-white mb-3">Comment ça marche</h2>
                        <p class="text-slate-500 dark:text-slate-400 max-w-xl mx-auto text-sm sm:text-base">Se rendre d'un point A à un point B n'a jamais été aussi simple et convivial.</p>
                    </div>
