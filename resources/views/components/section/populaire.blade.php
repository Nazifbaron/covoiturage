<section class="py-20 bg-background-light dark:bg-charcoal/50">
                <div class="max-w-7xl mx-auto px-6">
                    <div class="flex items-end justify-between mb-12 px-8 ">
                        <div>
                            <h2 class="text-3xl md:text-4xl font-extrabold text-deep-blue dark:text-white mb-2">Itinéraires populaires</h2>
