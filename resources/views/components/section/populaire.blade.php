<section class="py-12 sm:py-20 bg-background-light dark:bg-charcoal/50">
                <div class="max-w-7xl mx-auto px-4 sm:px-6">
                    <div class="flex items-end justify-between mb-8 sm:mb-12">
                        ...
                        <a href="/search" class="hidden md:flex items-center gap-2 text-primary font-bold hover:underline flex-shrink-0 ml-4">
                            Voir tous <span class="material-symbols-outlined">arrow_forward</span>
                        </a>
                    </div>
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        <div class="bg-white dark:bg-charcoal rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all border border-slate-100 dark:border-white/5">
                            <div class="h-48 bg-cover bg-center" style="background-image: url('{{ asset('images/itinéraire/etoile.jpg') }}')"></div>
                                <div class="p-6">
                                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 mb-4">
                                        <h3 class="text-base sm:text-xl font-bold text-deep-blue dark:text-white">Cotonou → Calavi</h3>
                                        <span class="text-primary font-bold text-sm sm:text-base">A partir de  500F CFA</span>
                                    </div>
                            ...
                            <div class="bg-white dark:bg-charcoal rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all border border-slate-100 dark:border-white/5">
                                ...
                                <div class="p-6">
                                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 mb-4">
                                        <h3 class="text-base sm:text-xl font-bold text-deep-blue dark:text-white">Cocotome → Pahou</h3>
                                        <span class="text-primary font-bold text-sm sm:text-base">A partir de 500F CFA</span>
                                    </div>
                                    <div class="flex items-center gap-4 text-sm text-slate-500 mb-6">
                            ...
                            <div class="bg-white dark:bg-charcoal rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all border border-slate-100 dark:border-white/5">
                                ...
                                <div class="p-6">
                                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 mb-4">
                                        <h3 class="text-base sm:text-xl font-bold text-deep-blue dark:text-white">Cotonou → Porto-Novo</h3>
                                        <span class="text-primary font-bold text-sm sm:text-base">A partir de 1000F CFA</span>
                                    </div>
                                    <div class="flex items-center gap-4 text-sm text-slate-500 mb-6">
