...
class DriverController extends Controller
{
    ...
    public function storeVehicle(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'insurance'         => ['required', 'file', 'mimes:pdf,jpg,jpeg,png', 'max:10000'],
            'registration'      => ['required', 'file', 'mimes:pdf,jpg,jpeg,png', 'max:10000'],
            'technical_control' => ['required', 'file', 'mimes:pdf,jpg,jpeg,png', 'max:10000'],
            'driver_license'    => ['required', 'file', 'mimes:pdf,jpg,jpeg,png', 'max:10000'],
            'vehicle_photo'          => ['nullable', 'file', 'mimes:jpg,jpeg,png', 'max:10000'],
            ...
            'technical_control.max'      => 'Le contrôle technique ne doit pas dépasser 10 Mo.',
